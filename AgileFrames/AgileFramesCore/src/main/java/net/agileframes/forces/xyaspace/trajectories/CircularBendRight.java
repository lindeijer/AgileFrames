...
/**
 * <b>A circular bend to the right with parameterized radius and endAngle.</b>
 * <p>
 * <img SRC="doc-files/CircularBendRight-1.gif" height=400 width=400> <br>
 * @author  H.J. Wierenga
 * @version 0.1
 */
public class CircularBendRight extends FuTrajectory {
  //--- Attributes ---
   ...
   * speedGamma=0.45<br>
   * speedMu=0.25<br>
   * @see   #CircularBendRight(double,double,XYATransform,double,double,double,double)
   */
  public CircularBendRight(double radius, double endAngle, XYATransform transform){
    this(radius,
         endAngle,
         transform,
         /*radius/5*/2.5,
  ...
  public CircularBendRight(
    ...
    double endY = radius * (Math.cos(endAngle) - 1);
