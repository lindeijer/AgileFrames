...
public class CounterClockwiseCrab extends FuTrajectory {
  private double distance = Double.NaN;

  public CounterClockwiseCrab(double distance, XYATransform transform) {
    this(distance, transform, Math.max(0.5, distance/5), 2.5, 0.25, 0.25);
  }
  public CounterClockwiseCrab(double distance, XYATransform transform, double pilotAlpha,
