...
/**
 * <b>A S-curve to the right with parameterized length and width.</b>
 * <p>
 * <img SRC="doc-files/SCurveRight-1.gif" height=200 width=400> <br>
 * @author  H.J. Wierenga
 * @version 0.1
 */
public class SCurveRight extends FuTrajectory {
  //--- Attributes ---
   ...
   * speedGamma=0.45<br>
   * speedMu=0.25<br>
   * @see   #SCurveRight(double,double,XYATransform,double,double,double,double)
   */
  public SCurveRight(double length, double width, XYATransform transform){
    this(length,
         width,
         transform,
         /*radius/5*/2.5,
