...
/**
 * A circular bend to the left with parameterized radius, p and endAngle.
 * @author Lindeijer, Evers, Wierenga
 * @version 0.0.1
 */

public class CircularBendLeft extends Trajectory {
  float radius;
  float p;
   ...
   */
  public CircularBendLeft(float radius, float p) {
  ...
  */
  public CircularBendLeft(float radius, float p, float endAngle) {
