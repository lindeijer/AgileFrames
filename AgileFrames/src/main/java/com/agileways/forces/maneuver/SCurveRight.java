...
/**
 * A S-curve to the right with parameterized length, width and p.
 * @author Lindeijer, Evers, Wierenga
 * @version 0.0.1
 */


public class SCurveRight extends Trajectory{
  ...
  /**
   * SCurveRight with p=0.
   */
  public SCurveRight(float length, float width) {
    this(length,width,0);
  }
   ...
   */
  public SCurveRight(float length, float width, float p) {
