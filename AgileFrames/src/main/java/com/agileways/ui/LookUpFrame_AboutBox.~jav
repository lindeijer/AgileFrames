...
public class LookUpFrame_AboutBox extends JDialog implements ActionListener {
  ...
  public LookUpFrame_AboutBox(Frame parent) {
    super(parent);
  ...
  private void jbInit() throws Exception  {
    ...
    label1.setText("AgileFrames - Look Up Frame");
    label2.setText(version);
    label3.setText("Copyright (c) 2001");
    label4.setText("Views all machines and actors on Jini Lookup Server");
