...
import com.agileways.demo.manoeuvres.ParkStraight;
...
public class Move6 extends Move {
  //-- Constructor --
  public Move6(FuTransform transform, int parkNr, int turnDirect) {
    super(transform);
    this.manoeuvre = new ParkStraight(transform, parkNr, turnDirect);
