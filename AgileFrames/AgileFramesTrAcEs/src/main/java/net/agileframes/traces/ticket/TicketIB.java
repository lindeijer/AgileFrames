...
/**
 * <b>Provides basic functionality common to all types of tickets.</b>
 * @see net.agileframes.core.traces.Ticket
 * @see PrimeTicket
 * @see CollectTicket
 * @see SelectTicket
 * @see SetTicket
 ...
 * @version  0.1
 */
public abstract class TicketIB implements Ticket {
  /**
  ...
  /** State indicating that the ticket and the event-process is waiting for its claim to be honored. */
  public static final int BLOCKING  = 3;
  /////////////////////////////////////////////////////////////////////
  /** The transaction-object for this ticket (to be used in SetTicket only). */
  protected Transaction transaction = null;
  ///////////////////////////////////////////////////////////////////////
  /** The tickets name may be arbitrary. */
  public String name = null;
  /**
   * Returns the name of this ticket.<p>
   * If no name is set, this method will return "anonymous".
   ...
   * @see #ASSIGNED
   * @see #BLOCKING
   * @param index the state of the ticket
   */
  ...
  /**
   * Returns the state of this ticket.
   * The tickets state must be one of the constants.
   * @see #INITIAL
   * @see #RESERVING
   * @see #ASSIGNED
  ...
  /**
   * Checks the state of this ticket.
   * The tickets state must be one of the constants.
   * @see #INITIAL
   * @see #RESERVING
   * @see #ASSIGNED
   * @see #BLOCKING
   * @param   index the state to check
   * @return  <code><b>true</code></b>  iff the state is the requested state<br>
   *          <code><b>false</code></b> iff the state is not the requested state
   */
   ...
   * @param scene_action  the scene action of this ticket
   */
  public TicketIB(String name,SceneAction scene_action) {
   ...
   * semaphores involved. <p> This call should last only milliseconds.
   * Calls _attempt.
   * @see net.agileframes.core.traces.Ticket#attempt()
   * @see PrimeTicket#_attempt()
   * @see CollectTicket#_attempt()
   * @see SelectTicket#_attempt()
   ...
   *  @see net.agileframes.core.traces.Ticket#reserve()
   *  @see PrimeTicket#_reserve()
   *  @see CollectTicket#_reserve()
   *  @see SelectTicket#_reserve()
   ...
   * atomic.
   * @see net.agileframes.core.traces.Ticket#insist()
   * @see PrimeTicket#_insist()
   * @see CollectTicket#_insist()
   * @see SelectTicket#_insist()
   ...
   * capacity.<p> This call should last only milliseconds. Event-process atomic.
   * @see net.agileframes.core.traces.Ticket#free()
   * @see PrimeTicket#_free()
   * @see CollectTicket#_free()
   * @see SelectTicket#_free()
  ...
  /**
   * Followed by reserve(Ticket,int). Any problem causes a ReserveDeniedException.<p>
   * @see net.agileframes.core.traces.Ticket#reserve(Transaction)
   * @see net.agileframes.core.traces.Ticket#reserve(Ticket,int)
   * @see net.agileframes.core.traces.Ticket#reserve()
   * @param   txn the transaction of this reserve
  ...
  /**
   * Preceded by reserve(Transaction), creates the callback structure.<p>
   * Last transaction committed. This method keeps re-trying upon RemoteExceptions.
   * @param   super_ticket  the super-ticket of the this ticket
   * @param   i             the index of this ticket
   * @return  true if the ticket is assigned, otherwise false
   */
