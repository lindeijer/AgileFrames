...
////////////// ATTEMPT //////////////////////////////////////////////////////
  ...
  */
  public synchronized boolean attempt(Ticket primeTicket) throws RemoteException {
	PrimeTicket prime_ticket = (PrimeTicket)  primeTicket;
...
////ABORT////////////////////////////
   ...
   */
  public synchronized void abort(Ticket primeTicket) throws RemoteException {
	PrimeTicket prime_ticket = (PrimeTicket)  primeTicket;
...
////////////// FREE ////////////////////////////////////////////////////////
   ...
   */
  public synchronized void free(Ticket primeTicket) throws RemoteException {
	PrimeTicket prime_ticket = (PrimeTicket)  primeTicket;
...
////////////// SNIP /////////////////////////////////////////////////////////
   ...
   */
  public synchronized int snip(Ticket primeTicket) throws RemoteException {
	PrimeTicket prime_ticket = (PrimeTicket)  primeTicket;
...
////////////// RESERVE ///////////////////////////////////////////////////////
   ...
   */
  public synchronized boolean reserve(Ticket primeTicket) throws RemoteException {
	PrimeTicket prime_ticket = (PrimeTicket)  primeTicket;
...
///////////////////// RESERVE(TRANSACTION) ////////////////////////////////////
   ...
   */
  public synchronized void reserve(Transaction tx,Ticket primeTicket)
...
//////// implementation of prime-ticket assignment ///////////////////////////
   ...
   */
  //changed by hw - 26/06/01
  private synchronized void assign(Ticket primeTicket) { // PrimeTicket
	PrimeTicket pt = (PrimeTicket)  primeTicket;
