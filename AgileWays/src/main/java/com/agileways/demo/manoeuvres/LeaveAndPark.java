...
public class LeaveAndPark extends DemoManoeuvre {
  //-- Attributes --
  //-- Constructor --
  public LeaveAndPark(FuTransform transform, int direct, int lane) {
    ...
    // specific flags:
    flags[3] = new PassedFlag(this, evolEnd - p1);// Passed semCross
