...
public class ManoeuvreB1 extends Manoeuvre {

  public ManoeuvreB1(FuTransform transform) {
    ...
    double end = 0;
    compTraj[0] = new CounterClockwiseCrab(CrossParameters.WIDTH_LANE/2, XYATransform.IDENTITY);
    ...
    compTraj[2] = new ClockwiseCrab(CrossParameters.WIDTH_LANE/2,
                  new XYATransform((XYASpace)compTraj[0].getTrajectPoint(end)));
