...
/**
 *  DoomStyleKeyBehavior is a generic behavior class to take key presses and move a
 ...
 *
 */
public class DoomStyleKeyBehavior extends Behavior
{
  ...
  public DoomStyleKeyBehavior( TransformGroup tg )
  {
    transformGroup = tg;
